//this javascrip was from html5media project
! function() {
	function e(e) {
	...
	function a(e) {
		return e = e || window.event, e.preventDefault ? (e.stopPropagation(), e.preventDefault()) : (e.returnValue = !
			1, e.cancelBubble = !0), !1
	}
	...
	function s(o, s, f) {
		function g() {
			function e(e) {
				...
				return !/iPad|iPhone|iPod/i.test(navigator.userAgent) || /.flv$/i.test(C[0].url) || t ? (S.isLoaded() ||
					S._fireEvent("onBeforeClick") === !1 || S.load(), a(e)) : !0
			}

			function t() {
				"" !== h.replace(/\s/g, "") ? o.addEventListener ? o.addEventListener("click", e, !1) : o.attachEvent &&
					o.attachEvent("onclick", e) : (o.addEventListener && o.addEventListener("click", a, !1), S.load())
			}
			$f(o) ? ($f(o).getParent().innerHTML = "", w = $f(o).getIndex(), p[w] = S) : (p.push(S), w = p.length - 1),
				E = parseInt(o.style.height, 10) || o.clientHeight, y = o.id || "fp" + u(), m = s.id || y + "_api", s
				.id = m, f.playerId = y, "string" == typeof f && (f = {
					clip: {
						url: f
					}
				}), "string" == typeof f.clip && (f.clip = {
					url: f.clip
				}), f.clip = f.clip || {}, o.getAttribute("href", 2) && !f.clip.url && (f.clip.url = o.getAttribute(
					"href", 2)), v = new c(f.clip, -1, S), f.playlist = f.playlist || [f.clip];
			var r = 0;
			n(f.playlist, function() {
					...
					t && (P[e] = new d(e, t, S))
				}), f.plugins && void 0 !== f.plugins.controls || (P.controls = new d("controls", null, S)), P.canvas =
				new d("canvas", null, S), h = o.innerHTML, setTimeout(t, 0)
		}
		...
		if (i(S, {
				...
				load: function(e) {
					if (!S.isLoaded() && S._fireEvent("onBeforeLoad") !== !1) {
						var t = function() {
								h = o.innerHTML, h && !flashembed.isSupported(s.version) && (o.innerHTML = ""),
									e && (e.cached = !0, l(x, "onLoad", e)), flashembed(o, s, {
										config: f
									})
							},
							r = 0;
				...
				function() {
					...
					S[e] = function(t, n) {
						...
						var r = null;
						return r = void 0 !== t && void 0 !== n ? L["fp_" + e](t, n) : void 0 === t ? L["fp_" + e]
						() : L["fp_" + e](t), "undefined" === r || void 0 === r ? S : r
					}
				...
				var i = t[0],
					...
					l = t[3],
					u = 0;
				if (f.debug && e(t), S.isLoaded() || "onLoad" != i || "player" != o || (L = L || r(m), _ = S
					._swfHeight(), n(C, function() {
						this._fireEvent("onLoad")
					}), n(P, function(e, t) {
						t._fireEvent("onUpdate")
					}), v._fireEvent("onLoad")), "onLoad" != i || "player" == o) {
					if ("onError" == i && ("string" == typeof o || "number" == typeof o && "number" == typeof a) && (o =
							a, a = l), "onContextMenu" == i) return void n(f.contextMenu[o], function(e, t) {
						t.call(S)
					});
					if ("onPluginEvent" != i && "onBeforePluginEvent" != i) {
						...
						return n(x[i], function() {
							return d = this.call(S, o, a), this.cached && x[i].splice(u, 1), d === !1 ? !1 :
								void u++
						}), d
					}
					var g = o.name || o,
	...
	var c = function(e, t, r) {
			...
			if (o.index = t, "string" == typeof e && (e = {
					...
					_fireEvent: function(e, l, u, f) {
						...
						l && -1 != "onBeforeBegin,onMetaData,onStart,onUpdate,onResume".indexOf(e) && (i(f, l),
							l.metaData && (f.duration ? f.fullDuration = l.metaData.duration : f.duration =
								l.metaData.duration));
						var d = !0;
	...
	window.flowplayer = window.$f = function() {
		...
		if (1 == arguments.length) return "number" == typeof a ? p[a] : "*" == a ? new f(p) : (n(p, function() {
			return this.id() == a.id || this.id() == a || this.getParent() == a ? (e = this, !1) :
				void 0
		}), e);
...
function() {
	...
	function o(e, r) {
		...
		o && !i.id && (i.id = "_" + ("" + Math.random()).substring(9)), i.id && (a += ' id="' + i.id + '"'), i
			.cachebusting && (i.src += (-1 != i.src.indexOf("?") ? "&" : "?") + Math.random()), a += i.w3c || !o ?
			' data="' + i.src + '" type="application/x-shockwave-flash"' :
			' classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"', a += ">", (i.w3c || o) && (a +=
				'<param name="movie" value="' + i.src + '" />'), i.width = i.height = i.id = i.w3c = i.src = null;
	...
	function a(e, n, r) {
		...
		if (u ? (n.onFail = n.version = n.expressInstall = null, e.innerHTML = o(n, r)) : a && l && flashembed
			.isSupported([6, 65]) ? (t(n, {
				src: l
			}), r = {
				MMredirectURL: location.href,
				MMplayerType: "PlugIn",
				MMdoctitle: document.title
			}, e.innerHTML = o(n, r)) : "" !== e.innerHTML.replace(/\s/g, "") || (e.innerHTML = "<h2>Flash version " +
				a + " or greater is required</h2><h3>" + (i[0] > 0 ? "Your version is " + i :
					"You have no flash plugin installed") + "</h3>" + ("A" == e.tagName ?
				...
				"A" == e.tagName && (e.onclick = function() {
	...
	l && (jQuery.tools = jQuery.tools || {}, jQuery.tools.flashembed = {
		version: "1.0.4",
		conf: u
	});
		...
		getVersion: function() {
			...
			if (navigator.plugins && "object" == typeof navigator.plugins["Shockwave Flash"]) {
				...
				try {
					...
					try {
						i = new ActiveXObject("ShockwaveFlash.ShockwaveFlash.6"), e = [6, 0], i
							.AllowScriptAccess = "always"
					} catch (a) {
						if (6 == e[0]) return e
					}
				...
				"object" == typeof i && (t = i.GetVariable("$version"), "undefined" != typeof t && (t = t
					.replace(/^\S+\s+(.*)$/, "$1").split(","), e = [parseInt(t[0], 10), parseInt(t[
						2], 10)]))
			}
			return e
		},
...
function() {
	...
	function n() {
		if (!a) {
			if (a = !0, document.addEventListener && !o.opera && document.addEventListener("DOMContentLoaded", e, !1), o
...
function(e, t, n) {
	...
	o.flowplayerSwf = m + "flowplayer.swf", o.flowplayerAudioSwf = m + "flowplayer.audio.swf", o.flowplayerControlsSwf =
		m + "flowplayer.controls.swf", o.expressInstallSwf = m + "expressInstall.swf", o.videoFallbackClass =
		"html5media-video-fallback", o.audioFallbackClass = "html5media-audio-fallback";
	...
	o.configureFlowplayer = function(e, t) {
		...
		if (a) {
			...
			b.id = n.id, b.style.cssText = n.style.cssText, b.className = n.className, b.title = n.title, n.style
				.display || (b.style.display = "block"), b.style.width = f(n, "width", "300px"), "audio" == e ? (b
					.style.height = f(n, "height", "26px"), b.className = (b.className ? b.className + " " : "") + o
					.audioFallbackClass) : (b.style.height = f(n, "height", "200px"), b.className = (b.className ? b
					.className + " " : "") + o.videoFallbackClass), n.parentNode.replaceChild(b, n);
			...
			y && S.controls && (S.controls.autoHide.enabled = !1), "audio" == e && (S.audio = {
				url: s(o.flowplayerAudioSwf)
			}, r || (S.controls = {
				url: s(o.flowplayerControlsSwf),
				display: "none"
